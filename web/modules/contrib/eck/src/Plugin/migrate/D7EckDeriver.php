...
class D7EckDeriver extends DeriverBase implements ContainerDeriverInterface {
   ...
   *
   * @var \Drupal\migrate\Plugin\MigrationManagerInterface
   */
   ...
   *   The migration plugin manager.
   */
  public function __construct($base_plugin_id, $translations, FieldDiscoveryInterface $field_discovery, MigrationPluginManagerInterface $migration_manager) {
